...
public class CounselingCallActivity_logout extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CounselingCallActivity_logout.this, "문장을 말씀하신 후 녹음정지 버튼을 눌러주세요.", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    RecognitionListener listener = new RecognitionListener() {
        ...
        public void onError(int i) {
            ...
            Toast.makeText(CounselingCallActivity_logout.this, "에러가 발생하였습니다. : " + message, Toast.LENGTH_SHORT).show();
        }
